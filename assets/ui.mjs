...
const state={dataset:null,module:'menu',filters:{},subtabs:{normal:'Tamaños',top:'Bebidas',audit:'Negativas'},files:[],loading:false,page:0,settings:saved(),result:null,report:null,maxminSelected:new Set(),openMulti:''};
...
$('resetButton').addEventListener('click',()=>{if(confirm('¿Cambiar tienda? Se retirarán los datos cargados de esta sesión.')){state.dataset=seed();state.files=[];state.filters={};state.maxminSelected.clear();state.module='menu';draw();}});
