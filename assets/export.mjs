...
function createPeakHourPdf(report){
 ...
 text(28,56,6.3,'OBJETIVO = PROMEDIO DEL BLOQUE PEAK + 5 TRANSACCIONES',true,'left','green');text(764,56,6.1,'REAL: captura digital o llena el recuadro al cierre',false,'right');return pdfFromPages([commands.join('\n')]);
}
